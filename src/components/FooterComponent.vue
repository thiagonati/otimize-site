<script setup></script>
<template>
    <section class="pt-16 bg-gray-900 pb-7">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-between gap-8 border-b border-gray-500 sm:flex-row pb-14">

                <img src="../assets/images/logomarca_otimize.png" alt="" class="w-32 h-auto">
                <div class="flex items-center gap-4">
                    <a href="javascript:;"
                        class="p-3 text-gray-700 transition-all duration-500 bg-white rounded-full group hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white">
                    ...
                    <a href="javascript:;"
                        class="p-3 text-gray-900 transition-all duration-500 bg-white rounded-full group hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path
            ...
            <div class="flex flex-col justify-between gap-8 border-b border-gray-500 py-14 lg:flex-row">
                <div
                    class="flex flex-col w-full gap-6 max-lg:mx-auto sm:flex-row max-lg:items-center max-lg:justify-between md:gap-12 lg:gap-24">
                    <div class="">
                        <h6 class="text-lg font-medium text-yellow-500 mb-7 max-lg:text-center">Otimize Soluções
                            Energéticas
                        </h6>
                        <ul class="flex flex-col gap-6 max-lg:items-center">
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 max-lg:text-center whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Home</a>
                            </li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 max-lg:text-center whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">About</a>
                            </li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 max-lg:text-center whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Pricing</a>
                            </li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 max-lg:text-center whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Pro
                                    Version</a></li>
                        </ul>
                    </div>
                    <div class="">
                        <h6 class="text-lg font-medium text-yellow-500 mb-7 max-lg:text-center">Products</h6>
                        <ul class="flex flex-col gap-6 max-lg:items-center">
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Figma
                                    UI System</a></li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Icons
                                    Assets</a></li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Responsive
                                    Blocks</a></li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Components
                                    Library</a></li>
                        </ul>
                    </div>
                    <div class="">
                        <h6 class="text-lg font-medium text-yellow-500 mb-7 max-lg:text-center">Resources</h6>
                        <ul class="flex flex-col gap-6 max-lg:items-center">
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">FAQs</a>
                            </li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Quick
                                    Start</a></li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Documentation</a>
                            </li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal text-gray-400 transition-all duration-300 whitespace-nowrap hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">User
                                    Guide</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="flex flex-col-reverse items-center justify-between gap-5 sm:flex-row pt-7">
                <span class="text-sm font-normal text-gray-400">
                    <a href="" class="">©Otimize Soluções Energéticas</a> 2023, All rights reserved.
                </span>
                <div class="relative text-gray-500 focus-within:text-gray-900 ">
                    <div class="absolute inset-y-0 flex items-center pl-3 pointer-events-none right-6 ">
